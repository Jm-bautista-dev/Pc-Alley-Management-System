...
const ProductRequest = sequelize.define('ProductRequest', {
  ...
  branch_approved_by: { type: DataTypes.INTEGER, allowNull: true, references: { model: 'users', key: 'id' } },
  branch_approved_at: { type: DataTypes.DATE, allowNull: true },
  branch_approval_notes: { type: DataTypes.TEXT, allowNull: true },
