      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden relative">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8 lg:p-10 custom-scrollbar relative z-10">
          ...
          >
            ...
            <p className="text-muted font-bold text-sm text-center uppercase tracking-[2px]">Preview Mode: Price Governance</p>
            <p className="text-muted/60 text-[10px] mt-4 uppercase tracking-[4px] text-center max-w-xs leading-relaxed">
              Dynamically adjust product valuations and discount tiers. Global market sync in progress.
            </p>
